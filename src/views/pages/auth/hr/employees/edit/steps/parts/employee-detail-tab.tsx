...
export interface EmployeeDetailTabProps {
  id: string | undefined;
  failed: boolean;
...
export default function EmployeeDetailTab(props: EmployeeDetailTabProps) {
  ...
  const handleChange = (e: any) => {
    if (tempUserData) {
      ...
      setTempUserData((prev: any) => ({ ...prev, [name]: value }));
    }
  };
        ...
        {failed ? (
          ...
          <>
            ...
            <CustomInput
              ...
              placeholder={t("enter_ur_pho_num")}
              defaultValue={tempUserData["family_mem_contact"]}
              type="text"
            ...
            <APICombobox
              ...
              onSelect={(selection: any) =>
                setTempUserData((prev: any) => ({ ...prev, gender: selection }))
              }
              lable={t("gender")}
